      ...
      <div className="max-w-md w-full relative">
        ...
        <div className="glass-card rounded-2xl p-8">
          <div className="text-center mb-8">
            <img className="mx-auto h-16 w-16 text-blue-400 animate-float" src="Photo/WhatsApp Image 2025-04-05 at 18.27.46_3c1c8cb3.jpg" alt="no" />
            {/* <Shield className="mx-auto h-16 w-16 text-blue-400 animate-float" /> */}
            <h2 className="mt-6 text-4xl font-bold gradient-text">
              Create Account
            </h2>
            <p className="mt-2 text-gray-400">Join MalwareGuard today</p>
          </div>
